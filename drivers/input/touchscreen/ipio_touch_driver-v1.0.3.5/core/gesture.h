...
#define KEY_GESTURE_DOWN				KEY_TP_GESTURE_SWIPE_DOWN
#define KEY_GESTURE_LEFT				KEY_TP_GESTURE_SWIPE_LEFT
#define KEY_GESTURE_RIGHT				KEY_TP_GESTURE_SWIPE_RIGHT
#define KEY_GESTURE_O					KEY_TP_GESTURE_O
#define KEY_GESTURE_E					KEY_TP_GESTURE_E //KEY_E
#define KEY_GESTURE_M					KEY_TP_GESTURE_M //KEY_M
